...
import com.todo.db.todo_db.service.CategoryService;
...
//CRUD METHODS
	...
	public Category insert(@RequestBody Category obj) {
		Category result = categoryService.insert(obj);
    ...
    //CRUD - EDIT
    @Secured({ "ROLE_PRIVATE_USER" })
	@RequestMapping(value = "/category/{id}", method = RequestMethod.POST, headers = "Accept=application/json")
	public Category update(@RequestBody Category obj, @PathVariable("id") Long id) {
		Category result = categoryService.update(obj, id);
