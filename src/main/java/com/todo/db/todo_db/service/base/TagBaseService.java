...
public class TagBaseService {
	...
	public Tag insert(Tag obj) {
		...
		String sql = "INSERT INTO `tag` (`_id`, `name`) VALUES (:id,:name)";
	...
	public void delete(Long id) {
		...
		String sql_tags = "DELETE FROM `todo_tags` WHERE `id_Tag`= :id";
	...
	public Tag update(Tag obj, Long id) {
		...
		String sql = "UPDATE `Tag` SET `name` = :name  WHERE `_id`=:id";
		SqlParameterSource parameters = new MapSqlParameterSource()
			.addValue("id", id)
			.addValue("name", obj.getName());
		jdbcTemplate.update(sql, parameters);
